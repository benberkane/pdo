...
$puissance = 7;
$annee = 2018;
$couleur = "noir');DROP TABLE voiture;";
...
/*on a vue qu'on utilise la methode prepar pour preparer une requete
    En suite y a deux facon delier les parametres
        avec BindParam
            ou
        En argument de execute
    Puis on utilise la méthode execute() pour la requete préparer
    Execute nous renvoie true si tout a bien fonctionné, false si non
...
$resultat = $requetePrepare = $bdd->prepare("INSERT INTO voiture (marque, modele, puissance, annee, couleur) VALUES (?, ?, ?, ?, ?)");
...
$requetePrepare->execute([
    ...
    if($resultat){
        echo "La $marque a bien ete ajouté";
    }else{
        echo "<p>il y a eu un souci avec l'enregistrement en base de donnée!<p>";
    }
